...
class P1MeterTest(unittest.TestCase):
    ...
    def test_meter_sample(self):
        s = read_p1_meter(p1_test_readline())
    ...
    def test_timestamp(self):
        ...
        s = read_p1_meter(p1_test_readline(sample))
    ...
    def test_malformed_data(self):
        ...
        s = read_p1_meter(p1_test_readline(sample))
        self.assertNotIn("sensor.dsmr_instantaneous_power_export", s)
    ...
    def test_unicode_error(self):
        ...
        s = read_p1_meter(p1_test_readline(sample))
        self.assertIn("sensor.dsmr_total_energy_export", s)
